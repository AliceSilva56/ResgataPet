...
import CriaConta from '@/views/CriarConta.vue';
...
const routes = [
  ...
  { path: '/CriarConta', nome: 'CriarConta', component: CriaConta}, // Final /CriarConta mostra a views de CriarConta
  { path: '/Reportar', nome: 'Reportar', component: Reportar} // Final /Reportar mostra a views de Reportar
];
